...
public class BinAdapter4 extends RecyclerView.Adapter<BinAdapter4.ViewHolder> {
    ...
    public BinAdapter4(ArrayList<String> bin) {
        this.bin = bin;
    }

    @Override
    public BinAdapter4.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mappingutamarv, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final BinAdapter4.ViewHolder viewHolder, int i) {
    ...
    private void applyClickEvents(final BinAdapter4.ViewHolder holder, final int position) {
        sbinn = LayoutKeempat.sbinnn;
        sbinFull = LayoutKeempat.sbinFull;
    ...
    private void clickEvents(final BinAdapter4.ViewHolder holder, final int position){
        c = holder.mNamaLorong;
